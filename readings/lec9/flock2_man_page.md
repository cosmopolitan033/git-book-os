...
## NAME     [top](https://man7.org/linux/man-pages/man2/flock.2.html#top_of_page)

```
       flock - apply or remove an advisory lock on an open file
```

## LIBRARY     [top](https://man7.org/linux/man-pages/man2/flock.2.html#top_of_page)

```
       Standard C library (libc, -lc)
```

## SYNOPSIS     [top](https://man7.org/linux/man-pages/man2/flock.2.html#top_of_page)
...
## DESCRIPTION     [top](https://man7.org/linux/man-pages/man2/flock.2.html#top_of_page)
...
## RETURN VALUE     [top](https://man7.org/linux/man-pages/man2/flock.2.html#top_of_page)
...
## ERRORS     [top](https://man7.org/linux/man-pages/man2/flock.2.html#top_of_page)
...
## VERSIONS     [top](https://man7.org/linux/man-pages/man2/flock.2.html#top_of_page)
...
## STANDARDS     [top](https://man7.org/linux/man-pages/man2/flock.2.html#top_of_page)

```
       BSD.
```

## HISTORY     [top](https://man7.org/linux/man-pages/man2/flock.2.html#top_of_page)
...
## NOTES     [top](https://man7.org/linux/man-pages/man2/flock.2.html#top_of_page)
...
## SEE ALSO     [top](https://man7.org/linux/man-pages/man2/flock.2.html#top_of_page)
